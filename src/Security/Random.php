...
namespace Tengyue\Infra\Security;

/**
 * Tengyue\Infra\Security\Random
 *
 ...
 * - /dev/urandom
 *
 * `Tengyue\Infra\Security\Random` could be mainly useful for:
 *
 ...
 *
 *<code>
 * $random = new \Tengyue\Infra\Security\Random();
 *
...
class Random
{
	 ...
	 *
	 * It is similar to `Tengyue\Infra\Security\Random:base64` but has been modified to avoid both non-alphanumeric
	 ...
	 *</code>
	 *
	 * @see    \Tengyue\Infra\Security\Random:base64
	 ...
	 * If $len is not specified, 16 is assumed. It may be larger in future.
	 *
	 * It is similar to `Tengyue\Infra\Security\Random:base58` but has been modified to provide the largest value that can
	 ...
	 *</code>
	 *
	 * @see    \Tengyue\Infra\Security\Random:base58
	 * @throws Exception If secure random number generator is not available or unexpected partial read
	 */
