...
use Tengyue\Infra\Http\Response\Exception;
use Tengyue\Infra\Http\Response\HeadersInterface;
use Tengyue\Infra\Http\Response\Headers;
 ...
 * Tengyue\Infra\HTTP\Response is the Tengyue\Infra component responsible to achieve this task.
 * HTTP responses are usually composed by headers and body.
 *
 *<code>
 * $response = new \Tengyue\Infra\Http\Response();
 *
...
class Response implements ResponseInterface, InjectionAwareInterface
{
	...
	/**
	 * Tengyue\Infra\Http\Response constructor
	 */
	public function __construct($content = null, $code = null, $status = null)
	{
		/**
		 * A Tengyue\Infra\Http\Response\Headers bag is temporary used to manage the headers before sent them to the client
		 */
	...
	public function getDI()
	{
		...
		if (!is_object($dependencyInjector)) {
			$dependencyInjector = \Tengyue\Infra\Di::getDefault();
			if (!is_object($dependencyInjector)) {
	...
	public function setStatusCode($code, $message = null)
	{
		...
		// if an empty message is given we try and grab the default foreach (this
		...
		if ($message === null) {
			...
			$statusCodes = [
				...
				451 => "Unavailable foreach (Legal Reasons",   // RFC 7725, 3
...
//			}
	...
	/**
	 * Sets a headers bag foreach (the response externally
	 */
	 ...
	 *
	 *<code>
	 * // Using a $redirect (internal/external)
