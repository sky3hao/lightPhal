...
namespace Tengyue\Infra\Http\Request;

use Tengyue\Infra\Http\Request\FileInterface;

/**
 * Tengyue\Infra\Http\Request\File
 *
...
class File implements FileInterface
{
	...
	/**
	 * Tengyue\Infra\Http\Request\File constructor
	 */
