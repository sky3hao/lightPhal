...
abstract class Job
{
     ...
     *
     * @param string $id
     * @return bool|Caster|Invoker|Job
     */
    ...
    {
        return $this->client->hGet($this->getJobKey(), $key);
    }
    ...
    protected function set($key, $val)
    {
        ...
        $this->client->hSet($this->getJobKey(), $key, $val);
    }
    ...
    protected function state($state)
    {
        ...
        $this->client->zRem($setKey . ':' . $this->injectors['tube'] . ':' . $this->injectors['state'],
            $this->injectors['id']);
    ...
    {
        return $this->queue->name . ':' . self::JOB_TAB . ':' . $this->injectors['id'];
    }
}